      ...
      <main className="flex-1 mx-auto w-full max-w-2xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="space-y-5">
          ...
          <Section
            ...
            description="Email notification preferences — saving these now so they're ready when email delivery launches."
          >
            <Row
            ...
            <div className="flex items-start gap-2 rounded-xl border border-amber-100 bg-amber-50 px-3.5 py-2.5">
              ...
              <p className="text-xs text-amber-700">
                <span className="font-semibold">Email delivery coming soon.</span> Your preferences are saved — we&apos;ll activate them when the notification system launches.
              </p>
            </div>
          </Section>
