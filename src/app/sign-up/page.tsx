      ...
      <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex">
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 lg:px-16">
          <div className="w-full max-w-sm">
            <div className="rounded-2xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-8 shadow-sm text-center">
          ...
          <div className="rounded-2xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-8 shadow-sm">
            ...
            <div className="group relative">
              <button
                type="button"
                disabled
                className="flex h-11 w-full items-center justify-center gap-3 rounded-xl border border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-700/50 text-sm font-medium text-gray-400 dark:text-slate-500 cursor-not-allowed opacity-60"
              >
              ...
              <div className="pointer-events-none absolute -top-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-lg bg-gray-900 dark:bg-slate-700 px-2.5 py-1 text-xs text-white opacity-0 transition-opacity group-hover:opacity-100">
                Coming soon
              </div>
            </div>
